...
const Navbar = () => {
    ...
    return (
        <nav
            className='w-auto h-auto flex flex-row fixed top-8 z-50 self-start p-3 gap-4 border-1 border-custom rounded-custom transition-all duration-500 ease-in-out bg-background'
